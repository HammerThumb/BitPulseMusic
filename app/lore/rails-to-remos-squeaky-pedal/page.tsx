export default function RailsToRemosPage() {
  ...
  style={{
    ...
    backgroundPosition: "50% 30%", // move “up” a bit (0% top … 100% bottom)
  }}
  aria-hidden="true"
/>
      ...
      {/* Page content (z-10 puts it above bg/overlay) */}
      <article className="relative z-10 max-w-3xl mx-auto px-6 py-24 md:py-28">
        ...
        <div className="space-y-4 leading-7">
          ...
          <p className="italic text-white/85">
            <span className="font-semibold"></span> The tunnel to Mirae took three years to renovate in preparation for the Sonarail’s expansion — an entire third story added so more passengers could make the rare, days-long journey across Sonaris aboard the only train that runs its rails.
          </p>
        </div>
      </article>
    </main>
